...
public class Vector {
    ...
    public Vector plus(Vector other) {
        if (this.size() != other.size()) {
            throw new IllegalArgumentException("org.jjophoven.math.Vector sizes must match.");
        }
    ...
    /**
     * Transforms this vector by a matrix (org.jjophoven.math.Matrix * org.jjophoven.math.Vector).
     * In linear algebra, this is the standard way to apply rotations, scales, or shears.
     * * @param m The transformation matrix.
     *
     * @return A new org.jjophoven.math.Vector resulting from the transformation.
    ...
    public Vector transform(Matrix m) {
        if (m.getColumns() != this.size()) {
            throw new IllegalArgumentException("org.jjophoven.math.Matrix columns must match vector size for transformation.");
        }
